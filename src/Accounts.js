...
<p>We'll send a confirmation code by text message to<br/>
           ...
           <input type="tel" id="number" placeholder="Phone Number" pattern="[0-9] {7-15}"></input>
       

          <div>
           <h6>We use phone numbers added here to help you log in, protect our<br/>
            community, accurately count people who use our services, and<br/> 
               ...
               other purposes including suggesting friends or providing ads.<br/></h6>
          </div>

          <div>
            <button id='btn'><p id='azp'>Send Code</p></button>
          </div>
        </div>
